 ...
 */
  ...
  // Obtenemos el nombre de usuario si está logueado, sino mostramos "Invitado"
  if ($loggedin) {
...
<head>
    ...
    <link href="<?php echo $urlApp ?>/assets/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-sRIl4kxILFvY47J16cr9ZwB07vP4J8+LH7qKQnuqkuIAvNWLzeN8tE5YBujZqJLB" crossorigin="anonymous">
...
<?php
  ...
  ?>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <a class="navbar-brand" href="<?php echo $urlApp; ?>/index.php">Artean</a>

        <div class="collapse navbar-collapse" id="navbarToggler">
            <ul class="navbar-nav mr-auto mt-2 mt-md-0">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $urlApp; ?>/app/signup.php">Registrarse</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $urlApp; ?>/app/login.php">Entrar</a>
                </li>
            </ul>
        </div>
    </nav>
